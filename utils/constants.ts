...
const MESSENGER_USERNAME_ID = "8104556316245571";
...
export const nav_links = [
    ...
    { label: "Bảo hành", href: "/chinh-sach?loai-chinh-sach=bao-hanh", icon: ShieldCheck },
    { label: "Vận chuyển", href: "/chinh-sach?loai-chinh-sach=van-chuyen", icon: Truck },
    { label: "Liên hệ", href: "/chinh-sach?lien-he=true", icon: Phone },
] as const;
